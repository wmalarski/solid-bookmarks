...
type FieldsetLabelProps = ComponentVariantProps<
  "label",
  typeof fieldsetLabelRecipe
>;
...
type FieldsetLegendProps = ComponentVariantProps<
  "legend",
  typeof fieldsetLegendRecipe
>;

export const FieldsetLegend: Component<FieldsetLegendProps> = (props) => {
  return (
    <legend {...props} class={fieldsetLegendRecipe({ class: props.class })} />
  );
};
